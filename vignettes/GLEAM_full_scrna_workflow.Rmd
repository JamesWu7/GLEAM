...
## 8) GLEAM embedding score plot (Seurat-based)
...
```{r step9-dotbar, eval=seurat_ok, fig.width=12.2, fig.height=7.2, out.width="100%"}
plot_dot_bar(
  sc,
  by = c("group", "celltype"),
  signature = top_sig,

...
```{r spatial-seurat-object, eval=requireNamespace("Seurat", quietly = TRUE), fig.width=9.6, fig.height=7.0, out.width="96%"}
library(Seurat)
...
```{r spatial-slice-view, eval=requireNamespace("Seurat", quietly = TRUE), fig.width=10.8, fig.height=8.0, out.width="100%"}
...
```{r spatial-differential, eval=requireNamespace("Seurat", quietly = TRUE), fig.width=11.2, fig.height=8.2, out.width="100%"}

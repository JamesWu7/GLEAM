test_that("export and method comparison utilities work", {
  ...
  s1 <- score_signature(expr = toy_expr$expr, meta = toy_expr$meta, geneset = "immune_small", seurat = FALSE, method = "rank", min_genes = 3, verbose = FALSE)
  s2 <- score_signature(expr = toy_expr$expr, meta = toy_expr$meta, geneset = "immune_small", seurat = FALSE, method = "mean", min_genes = 3, verbose = FALSE)

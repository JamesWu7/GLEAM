...
2.  Robust extraction from `stxBrain_anterior1` + `stxBrain_posterior1`
    without fragile image-slot merge
...
To avoid Seurat image-slot version breakpoints (`VisiumV2` compatibility
issues), we load Seurat spatial objects, then combine
...
![](GLEAM_quickstart_spatial_files/figure-html/spatial-slice-view-1.png)
...
![](GLEAM_quickstart_spatial_files/figure-html/spatial-differential-1.png)

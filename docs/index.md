...
![GLEAM logo](reference/figures/GLEAM_LOG.jpg)

GLEAM: Gene-set and cell-state exploration across space and time in R

![R-CMD-check](https://github.com/JamesWu7/GLEAM/actions/workflows/R-CMD-check.yaml/badge.svg)![pkgdown](https://github.com/JamesWu7/GLEAM/actions/workflows/pkgdown.yaml/badge.svg)
...
![Dot-bar signature
comparison](reference/figures/signature_dotbar_compare.png)![Trajectory
signature trend](reference/figures/trajectory_signature_trend.png)
...
visualization](reference/figures/embedding_signature_feature.png)
...
visualization](reference/figures/spatial_slice_signature.png)

...
plot_embedding_score(sc, signature = top_sig, object = seu, reduction = "umap", point_size = 0.62) +
...
plot_spatial_score(sp, signature = rownames(sp$score)[1], object = sp_obj, point_size = 1.65) +
...
plot_dot_bar(sc_vis, by = c("group", "celltype"), signature = top_sig) +
...
plot_violin(sc_vis, signature = top_sig, group = "celltype", point_size = 0.25, alpha = 0.7) +
...
plot_split_violin(sc_vis, signature = top_sig, x = "celltype", split.by = "group", alpha = 0.74) +

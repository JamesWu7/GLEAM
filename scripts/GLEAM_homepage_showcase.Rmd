...
p_embedding <- Seurat::FeaturePlot(
  object = seu,
...
apply_showcase_style(p_embedding, "Signature score on embedding (Seurat FeaturePlot)")
```
...
p_spatial <- tryCatch(
  ...
  error = function(e) {
    message("[GLEAM] SpatialFeaturePlot fallback: ", conditionMessage(e))
    plot_spatial_score(sp, pathway = sig_spatial, object = sp_obj)
  }
)

apply_showcase_style(p_spatial, "Signature score on spatial slice (Seurat SpatialFeaturePlot)")
```
